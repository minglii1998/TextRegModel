...
parser.add_argument('--expr_dir', default='../expr_no_bn_1d/', help='Where to store samples and models')
...
loader_totensor = transforms.Compose([
    transforms.ToTensor()]) 

unloader_fromtensor = transforms.ToPILImage()
...
model = resNet.resnext50(num_classes = 3200)
